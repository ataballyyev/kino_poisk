...
public final class FragmentDetailsBinding implements ViewBinding {
  ...
  private FragmentDetailsBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardImage,
      @NonNull ImageView imageView, @NonNull TextView rating, @NonNull ImageView ratingIcon,
      @NonNull TextView title, @NonNull TextView year) {
  ...
  public static FragmentDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDetailsBinding((ConstraintLayout) rootView, cardImage, imageView, rating,
          ratingIcon, title, year);
    }
